...
import TechCore3D from "./techstack/TechCore3D.vue"
import TechCoreHud from "./techstack/TechCoreHud.vue"
import { categories, totalTechnologies, totalCategories } from "./techstack/techStackData.js"
  ...
  <section
    ...
    <div class="px-content relative z-10 w-full max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-12 flex flex-col items-center">
      ...
      <div class="techstack-layout">
        ...
        <!-- Right spacer (detail shown inside HUD on mobile) -->
        <div class="techstack-layout__right"></div>
      </div>
...
@media (min-width: 1280px) {
  .techstack-layout__right { order: 3; display: block; }
}
